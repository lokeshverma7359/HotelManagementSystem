    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            try {
                ...
                String age = t2.getText().trim();
                String company = t3.getText().trim();
                String brand = t4.getText().trim();
                String location = t5.getText().trim();
                
                // Input validation
                if (name.isEmpty() || age.isEmpty() || company.isEmpty() || 
                    brand.isEmpty() || location.isEmpty()) {
                ...
                ee.printStackTrace();
                JOptionPane.showMessageDialog(null, "Database error: " + ee.getMessage());
            } finally {
                try {
